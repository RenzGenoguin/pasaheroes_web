      ...
      render: (data: any) => (
        <div className=" flex flex-row items-center justify-center gap-2">
          <button
            ...
            className="flex-1   cursor-pointer rounded border-none bg-orange-400 py-1 text-white"
          >
            Edit
          </button>
          <button
            onClick={() => openModal("delete", data)}
            className=" flex-1 cursor-pointer  rounded border-none bg-red-400 py-1 text-white"
          >
            Delete
          </button>
        </div>
        ...
        <div className=" flex  flex-col ">
          <div className=" flex-col rounded bg-white p-3">
            ...
            >
              ...
              <Form.Item
                name={"vehicleType"}
                rules={[{ required: true, message: "Vehicle type is blank" }]}
              >
              ...
              >
                {createIsLoading ? "Adding ..." : "Add Vehicle Type"}
              </button>
            </Form>
          </div>
        </div>
        ...
        <div className=" min-h-96 flex flex-col rounded  bg-white">
          <div className=" flex w-full items-center justify-between">
            ...
            <button
              ...
              className="cursor-pointer  rounded border-none bg-blue-500 px-5 py-1 text-base text-white hover:brightness-110"
            >
              Add Vehicle Type
            </button>
          </div>
